...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //then create variable to get tasks from local storage 
    const existingTasks = myTasks.getTasks();

    taskwrapper = document.getElementById('taskWrapper');
    taskWrapperEmpty = document.getElementById('taskWrapperEmpty');
            ...
            <div class="task-card flex flex-col gap-5">
                            <div class="flex gap-3 items-center">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="text-sm leading-[21px] text-taskia-grey">Created at</p>
                                </div>
                            </div>
